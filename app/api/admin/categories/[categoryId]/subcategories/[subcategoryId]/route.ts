...
import { LinkedProductsError, updateAdminSubcategory } from "@/lib/server/admin-categories";
...
export async function PATCH(
  ...
  try {
    ...
    const result = await updateAdminSubcategory(params.categoryId, params.subcategoryId, payload);
